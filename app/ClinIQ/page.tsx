...
// Import the same data structures and mock data from dashboard
type Challenge = {
  id: number
  title: string
  company: string
...
const jobPostings = [
  ...
  { id: 4, role: 'Front End Developer', company: 'ClinIQ', composition: 'Contains 3 Assessments: 1 System Design + 2 Algo' },
  { id: 5, role: 'Back End Developer', company: 'ClinIQ', composition: 'Contains 4 Assessments: 2 System Design + 2 Algo' },
]
...
export default function ClinIQPage() {
  ...
  useLayoutEffect(() => {
    ...
    setIsFavorite(favorites.includes('ClinIQ'))
  }, [])
  ...
  const toggleFavorite = () => {
    const favorites = JSON.parse(localStorage.getItem('favoriteCompanies') || '[]')
    if (isFavorite) {
      const updated = favorites.filter((name: string) => name !== 'ClinIQ')
      localStorage.setItem('favoriteCompanies', JSON.stringify(updated))
      setIsFavorite(false)
    } else {
      favorites.push('ClinIQ')
  ...
  // Always render HeroHeader initially to match server render, then switch after client-side hydration
                    ...
                    {searchResults.companies.map((company) => {
                      ...
                      return (
                        <Card
                          ...
                          onClick={() => {
                            if (isClinIQ) {
                              // Already on ClinIQ page, just scroll to top
                      ...
                      return (
                        ...
                        >
                          ...
                          <CardContent className="p-6 relative z-10">
                            ...
                            >
                              {isClinIQ ? 'View on Page' : 'Start Application Track'}
                            </Button>
                          </CardContent>
                        </Card>
                      )
      ...
      <main className="min-h-screen bg-background pt-24">
        <div className="mx-auto max-w-6xl px-6 py-12">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h1 className="text-4xl font-bold">ClinIQ</h1>
                      {user && (
                        <Button
                          variant="ghost"
                          size="icon"
                    ...
                    <p className="text-muted-foreground text-lg">Healthcare Technology Solutions</p>
                    <div className="mt-4 flex flex-wrap gap-2">
                      <Badge variant="outline" className="text-sm">Healthcare Tech</Badge>
                      <Badge variant="outline" className="text-sm">Medical Software</Badge>
                      <Badge variant="outline" className="text-sm">Patient Care</Badge>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="relative border-border/50 bg-card/50 backdrop-blur-sm">
              ...
              <CardContent className="relative z-10 p-6">
                <p className="text-muted-foreground leading-relaxed text-base">
                  ClinIQ is a leading healthcare technology company dedicated to revolutionizing patient care through innovative software solutions. 
                  We specialize in developing cutting-edge medical applications that improve healthcare delivery, patient outcomes, and operational efficiency. 
                  Our team of passionate engineers and healthcare professionals work together to create products that make a real difference in people&apos;s lives.
                </p>
              </CardContent>
            </Card>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card className="relative border-border/50 bg-card/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10">
                <Spotlight size={250} />
                <CardHeader className="relative z-10">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <CardTitle className="text-xl mb-2">Front End Developer</CardTitle>
                      <CardDescription>Build beautiful and intuitive healthcare applications</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="relative z-10">
                  <p className="text-sm text-muted-foreground mb-4">
                    We&apos;re looking for a talented Front End Developer to join our team. You&apos;ll work with React, TypeScript, and modern UI frameworks 
                    to create exceptional user experiences for healthcare professionals and patients.
                  </p>
              ...
              <Card className="relative border-border/50 bg-card/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10">
                ...
                <CardHeader className="relative z-10">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <CardTitle className="text-xl mb-2">Back End Developer</CardTitle>
                      <CardDescription>Design robust and scalable healthcare systems</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="relative z-10">
                  <p className="text-sm text-muted-foreground mb-4">
                    Join our backend team to build secure, HIPAA-compliant APIs and services that power our healthcare platform. 
                    Experience with Node.js, Python, or Go preferred.
                  </p>
                  <div className="flex flex-wrap gap-2 mb-4">
          ...
          {/* Get ClinIQ Ready Section */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4">Get ClinIQ Ready...</h2>
            <div className="relative">
                      ...
                      <CardContent className="relative z-10 space-y-4">
                        <Card className="border-border/50 bg-card/80">
                          <CardContent className="p-4">
                            <h3 className="font-semibold mb-2 text-lg">Patient Portal Dashboard</h3>
                            <p className="text-sm text-muted-foreground mb-4">
                              Build a patient portal dashboard using React, TypeScript, and Tailwind CSS. 
                              This project will help you understand our frontend architecture and design patterns.
                            </p>
                      ...
                      <CardContent className="relative z-10 space-y-4">
                        <Card className="border-border/50 bg-card/80">
                          <CardContent className="p-4">
                            ...
                            <p className="text-sm text-muted-foreground mb-3">
                              A classic problem to test your problem-solving skills and understanding of data structures.
                            </p>
                        ...
                        <Card className="border-border/50 bg-card/80">
                          <CardContent className="p-4">
                            ...
                            <p className="text-sm text-muted-foreground mb-3">
                              Practice working with intervals - a common pattern in healthcare scheduling systems.
                            </p>
                            <Button variant="outline" size="sm" className="w-full">Go</Button>
                          </CardContent>
                        </Card>
                        ...
                        <Card className="border-border/50 bg-card/80">
                          <CardContent className="p-4">
                            <div className="flex items-center justify-between mb-2">
                              <h3 className="font-semibold">Binary Tree Maximum Path Sum</h3>
                              <Badge variant="outline" className="bg-red-500/10 text-red-500 border-red-500/20">
                                Hard
                              </Badge>
                            </div>
                            <p className="text-sm text-muted-foreground mb-3">
                              Challenge yourself with advanced tree algorithms used in medical data structures.
                            </p>
                            <Button variant="outline" size="sm" className="w-full">Go</Button>
                          </CardContent>
                        </Card>
                  ...
                  <CarouselItem>
                    <Card className="relative min-h-[450px] border-border/50 bg-card/50 backdrop-blur-sm">
                      ...
                      <CardHeader className="relative z-10">
                        ...
                        <CardDescription>Get ClinIQ ready with these modules of topics</CardDescription>
                      </CardHeader>
                      <CardContent className="relative z-10">
                        <div className="space-y-4">
                                ...
                                <CardContent className="p-4">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                      ...
                                      <p className="text-xs text-muted-foreground">JavaScript, TypeScript, React basics</p>
                                    </div>
                                  </div>
                                </CardContent>
                              </Card>
                                  ...
                                  <CardContent className="p-4">
                                    <div className="flex items-center gap-3">
                                      ...
                                      <div className="flex-1">
                                        ...
                                        <p className="text-xs text-muted-foreground">Redux, Context API, Zustand</p>
                                      </div>
                                    </div>
                                  </CardContent>
                                </Card>
                                  ...
                                  <CardContent className="p-4">
                                    <div className="flex items-center gap-3">
                                      ...
                                      <div className="flex-1">
                                        ...
                                        <p className="text-xs text-muted-foreground">REST, GraphQL, WebSockets</p>
                                      </div>
                                    </div>
                                  </CardContent>
                                </Card>
                                ...
                                <Card className="border-border/50 bg-card/80">
                                  <CardContent className="p-4">
                                    <div className="flex items-center gap-3">
                                      ...
                                      <div className="flex-1">
                                        <h4 className="font-semibold text-sm">Healthcare Standards</h4>
                                        <p className="text-xs text-muted-foreground">HL7, FHIR, HIPAA compliance</p>
                                      </div>
                                    </div>
                                  </CardContent>
                                </Card>
                          ...
                          <p className="text-sm text-muted-foreground mt-6 text-center">
                            Get ClinIQ ready with these modules of topics
                          </p>
